...
- **collation_korean_titles.sql**: MariaDB collation 검증용 한글 제목 데이터
  - 한글 제목의 코드포인트 정렬 검증
  - 대소문자 다른 제목을 다른 값으로 취급하는지 검증
  - [Portable Text Collation Policy](../../../docs/portable-text-collation-policy.md) §4 한글 정렬 목표 검증용
  - `test_mariadb_collation_fixture.py`에서 사용
