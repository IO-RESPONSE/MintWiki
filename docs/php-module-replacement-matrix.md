...
| parser | pass | partial | `php/src/Modules/Parser/{InlineParser,InlineParseResult,BlockParser,BlockParseResult}.php` 존재(태스크 0704-0705, NamuMark 인라인·블록 파서), fixture parity 러너 없음 |
