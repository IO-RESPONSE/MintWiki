...
[Job Runner URL Guide](job-runner-url-guide.md)에서 다룬다.
...
- 호스팅사별 cron 설정 예시의 구현 의존성은
  [Job Runner URL Guide](job-runner-url-guide.md)의 자리표시자를 따른다.
...
- [Job Runner URL Guide](job-runner-url-guide.md) —
  runner URL 형식과 shared hosting cron 설정 예시.
